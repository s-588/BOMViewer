CREATE TABLE materials (
    ...
    unit INT NOT NULL REFERENCES unit_types(unit_id) ON DELETE SET NULL,                   
    description TEXT                           
);
...
CREATE UNIQUE INDEX unique_primary_name_per_material
ON material_names(material_id) WHERE is_primary = 1;
